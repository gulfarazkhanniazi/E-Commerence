...
export default function Contact() {
  return (
    <StyledWrapper className="mt-14">
  <div className="landing_page">
    <div className="responsive-container-block big-container">
      <img className="bg-img" id="iq5bf" src="https://workik-widget-assets.s3.amazonaws.com/widget-assets/images/clothes-bg.png" alt="Background" />
        ...
        <div className="responsive-cell-block wk-desk-6 wk-ipadp-6 wk-tab-12 wk-mobile-12 left-one">
          <div className="content-box">
            ...
            <p className="text-blk section-subhead text-lg">
              Have questions or need assistance? Our team is here to help. Contact us for inquiries about our products, services, or business collaborations. We’re happy to assist you!
            </p>
<div className="card">
        ...
        <div className="responsive-cell-block wk-ipadp-6 wk-tab-12 wk-mobile-12 wk-desk-6 right-one" id="i1zj">
          <form className="form-box">
            <div className="container-block form-wrapper">
              <p className="text-blk contactus-head text-center">Get a Quote</p>
              <p className="text-blk contactus-subhead text-center">
                Let us know your requirements, and we’ll get back to you within 24 hours with a tailored solution.
              </p>
              <div className="responsive-container-block">
                <div className="responsive-cell-block wk-tab-12 wk-mobile-12 wk-desk-12 wk-ipadp-12" id="i10mt-7">
                  <input className="input" id="ijowk-7" name="FirstName" placeholder="First Name" required />
                </div>
                <div className="responsive-cell-block wk-tab-12 wk-mobile-12 wk-desk-12 wk-ipadp-12" id="i1ro7">
                  <input className="input" id="indfi-5" name="LastName" placeholder="Last Name" required />
                </div>
                <div className="responsive-cell-block wk-tab-12 wk-mobile-12 wk-desk-6 wk-ipadp-6 emial" id="ityct">
                  <input className="input" id="ipmgh-7" name="Email" type="email" placeholder="Email" required />
                </div>
                <div className="responsive-cell-block wk-desk-6 wk-ipadp-6 wk-tab-12 wk-mobile-12">
                  <input className="input" id="imgis-6" name="PhoneNumber" type="tel" placeholder="Phone Number" required />
                </div>
                <div className="responsive-cell-block wk-tab-12 wk-mobile-12 wk-desk-12 wk-ipadp-12" id="i634i-7">
                  <textarea className="textinput" id="i5vyy-7" placeholder="Type your message here..." required></textarea>
                </div>
              </div>
              <button className="btn mb-4">Get Quote</button>
            </div>
          </form>
        </div>
      </div>
