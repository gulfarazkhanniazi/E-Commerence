...
export default function ExclusiveFeatures() {
  return (
    <div className="mt-28 bg-gray-800 px-4 sm:px-10 py-12">
        <hr />
        <div className="max-w-7xl mx-auto my-8 text-gray-200">
          ...
          <div className="grid lg:grid-cols-3 sm:grid-cols-2 gap-8 mt-14">
            ...
            <div>
            <MdSecurity className="w-8 fill-blue-600 mb-4 inline-block text-3xl" />
            ...
            <div>
            <FaComments className="w-8 fill-blue-600 mb-4 inline-block text-3xl" />
        ...
        <hr />
        <div className="mt-28 text-gray-200 bg-gray-800 px-4 sm:px-10 py-12">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 items-center gap-8">
            <div className="space-y-6 bg-gray-700 rounded-md p-6 max-w-md max-md:order-1">
              ...
              <div
                className="flex sm:items-center max-sm:flex-col-reverse p-6 relative lg:left-12 bg-gray-600 shadow-[0_2px_20px_-4px_rgba(93,96,127,0.2)] rounded-md">
                <div className="mr-3">
