...
<main className="pt-24 pb-16 lg:pt-16 lg:pb-24S dark:bg-gray-900 antialiased bg-gray-800 text-gray-300">
  <div className="flex justify-between px-4 mx-auto max-w-screen-xl ">
      <article className="mx-auto w-full max-w-2xl format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
          <header className="mb-4 lg:mb-6 not-format">
              <h1 className="mb-4 text-3xl font-extrabold leading-tight lg:mb-6 lg:text-4xl">Best practices for successful prototypes</h1>
          </header>
          ...
          <p>But then I found a <Link href="https://flowbite.com">component library based on Tailwind CSS called
          ...
          <section className="not-format">
              <div className="flex justify-between items-center mb-6">
                  <h2 className="text-lg lg:text-2xl font-bold mt-6">Discussion</h2>
              </div>
              <form className="mb-6">
                  ...
                  <button type="submit"
                      className=" w-full py-2.5 px-4 text-xs font-medium text-center text-white bg-red-600 rounded-lg">
                      Post comment
                  </button>
              </form>
              <article className="p-6 mb-6 text-base shadow-xl">
                  <footer className="flex justify-between items-center mb-2">
                      <div className="flex items-center">
                          <p className="inline-flex items-center mr-3 font-semibold text-sm text-gray-400"><img
                                  className="mr-2 w-6 h-6 rounded-full"
                                  src="https://flowbite.com/docs/images/people/profile-picture-2.jpg"
                                  alt="Michael Gough"/>Michael Gough</p>
                          <p className="text-sm text-gray-400"><time pubdate="true" dateTime="2022-02-08"
...
<hr />
<aside aria-label="Related articles" className="py-8 lg:py-24 bg-gray-800 text-gray-300">
  <div className="px-4 mx-auto max-w-screen-xl">
      ...
      <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
          <article className="max-w-xs">
              ...
              <p className="mb-4">Over the past year, Volosoft has undergone many changes! After months of preparation.</p>
